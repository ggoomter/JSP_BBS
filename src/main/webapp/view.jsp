...
<body>
				...
				<div class="container">
								<div class="row">
												<form method="post" action="commentAction.jsp">
																...
																<input type="hidden" name="actionType" value="insert"> <input type="hidden" name="bbsID" value="<%=bbs.getBbsID()%>">
																<table class="table table-striped" style="text-align: center; border: 2px solid #dddddd; height: 70px;">
																				<tr>
																								...
																								<td class="col-md-8"><textarea id="commentText" style="height: 50px;" class="form-control" placeholder="댓글을 입력해주세요."
																																name="commentText"></textarea></td>
																								<!-- 제출버튼 -->
																								<td class="col-md-3 align-middle"><input type="button" id="commentTextResetButton" class="btn btn-dark" value="초기화"
																												onclick="resetCommentText();" /></input> <input type="submit" id="commentTextActionButton" class="btn btn-info"></input></td>
																				</tr>
																</table>
												</form>
								</div>
												...
												<table id="commentTable" class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
																...
																<tbody>
																				...
																				<tr>
																								...
																								<!-- 작성자 -->
																								<td class="col-md-7"><%=list.get(i).getCommentText()%></td>
																								<!-- 댓글내용 -->
																								<td class="col-md-2"><%=list.get(i).getCommentDate()%></td>
																								<!-- 댓글작성날짜 -->
																								...
																								<td class="col-md-1 ">
																												...
																												onclick="updateComment(<%=list.get(i).getBbsID()%>, <%=list.get(i).getCommentID()%>);" /> <!-- 댓글삭제버튼 --> <img
																												class="minusBtn" src="images/red_minus.png" alt=""
																												onclick="confirmDelete(<%=list.get(i).getBbsID()%>, <%=list.get(i).getCommentID()%>);" />
																								</td>
    ...
    function deleteComment(bbsID, commentID){
    	...
    	/* "bbsID="+bbsID+"&commentID="+commentID+"&type=delete"; */
